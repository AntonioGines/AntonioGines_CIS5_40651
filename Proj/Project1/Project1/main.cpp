...
int main(int argc, char** argv) {
    ...
    card3=(rand()%11)+1;
    card4=(rand()%11)+1;
    dealer1=(rand()%11)+1;                //Dealer's Randomized Cards
    dealer2=(rand()%11)+1;
    dealer3=(rand()%11)+1;
    ...
    if(card1==card2){                      //Choices when you are able to split
        ...
        cout<<"If you wish to Stay type S"<<endl;
    ...
    switch(choice){                       //Begin switch based on input
        case 'H':do{                      //Choosing to hit
                    ...
                    if(card3>card2){      //Saving input to determine max value
                        rng2=card3;       //of a single card in a hand
                    }else rng2=card1;
        ...
        dealtot=dealer1+dealer2;               //If it's not an immediate bust
        cout<<"The dealer will now reveal their second card and choose whether "
             <<"or not to hit"<<endl;
        cout<<"The dealer's second card is:"<<endl;
        cout<<dealer2<<endl;
        while(dealtot<15||dealtot<total){      //Determine whether dealer hits
            dealer3=(rand()%11)+1;
            dealtot+=dealer3;
